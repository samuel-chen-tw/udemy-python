...
def add_new_post():
    ...
    if form.validate_on_submit():
        new_post = BlogPost(title=form.title.data, subtitle=form.subtitle.data,
                            author=form.author_name.data, body=form.body.data,
...
def edit_post(post_id):
    ...
    edit_form = CreatePostForm(title=post.title, subtitle=post.subtitle, img_url=post.img_url, author_name=post.author,
                               body=post.body)
